						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<?php echo htmlentities($_SESSION['msg1']="");?></p>	--->
													<form role="form" name="book" action="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/CreateFileFTS/process" method="post" enctype="multipart/form-data">
														


<div class="form-group">
														<span class="input-icon">
									<input type="text" class="form-control" name="file_name" placeholder="File Title">
...
<div class="form-group">
														<span class="input-icon">
									<input type="text" class="form-control" name="file_type" placeholder="File Type">
									<i class="fa fa-user"></i> </span>
														</div>
...
<div class="form-group">
														<span class="input-icon">	<i class="fa fa-user"></i><br><br> </span>

															<a><h4>Sender: <?php echo $this->session->userdata('DeptName');?></h4></a>
									<input type="hidden" class="form-control" name="sender_id" value="<?php echo $this->session->userdata('DeptId');?>" >
...
<div class="form-group">
														<span class="input-icon">
									<input type="text" class="form-control" name="text" placeholder="Additional Comment">
									<i class="fa fa-user"></i> </span>
														</div>

<a><strong>Upload Left Hand Side Comment</strong></a>
<div class="form-group">
														<span class="input-icon">
...
<a><strong>Upload Righ Hand Side Documents</strong></a>
<div class="form-group">
														<span class="input-icon">
...
<div class="form-group">
									...
									<i class="fa fa-user"></i> </span>
														...
														<button type="submit" name="submit" value="upload" class="btn btn-o btn-primary">
															Submit
														</button>
													</form>
												</div>
