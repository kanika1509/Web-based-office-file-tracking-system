				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">User | Forward File</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>User</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Forward File</h5>
												</div>
												<div class="panel-body">
								<p style="color:red;"><?php echo htmlentities($_SESSION['msg1']);?>
								<?php echo htmlentities($_SESSION['msg1']="");?></p>	
								<form role="form" name="book" action="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/ForwardFileContr/process" method="post" enctype="multipart/form-data" >						
									<div class="form-group">
										<span class="input-icon">	<i class="fa fa-user"></i><br><br> </span>

															<a><h4>File ID: <?php echo $forward_id;?></h4></a>
									<input type="hidden" class="form-control" name="file_id" value="<?php echo  $forward_id;?>" >
