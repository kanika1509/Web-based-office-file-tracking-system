									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												<a href="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/AddDepartmentController">
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="cl-effect-1">
												<a href="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/TrackPageController1">
													View A File
												</a>
											</p>
										</div>
					...
					<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="cl-effect-1">
												<a href="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/ViewFeedbackController">
													View Feedback
												</a>
											</p>
										</div>
