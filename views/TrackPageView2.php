	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					<form class="form-login" action="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/TrackPageController2/process" method="post">
						<fieldset>
							<legend>
								Track your File
							</legend>
				...
				<div class="box-login">
					<form class="form-login" action="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/TrackPageController2/process2" method="post">
						<fieldset>
							<legend>
								Track your File
							</legend>
