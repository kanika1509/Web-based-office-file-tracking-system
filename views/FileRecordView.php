...
foreach($FileDetails as $row){
	if($t==0)
	{
	if($row->sender_id!=$this->session->userdata('DeptId'))
		continue;
	else
		$t=1;
}
?>
											...
											<tr>
												...
												<td ><?php $id= $row->sender_name;  echo $id;?></td>
												...
												if($status==0)
													...
													echo "completed";?></td>
												<td><a href="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/uploads/<?php echo $row->file1 ?>"><?php echo $row->file1;?></a></td>
												<td><a href="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/uploads/<?php echo $row->file2 ?>"><?php echo $row->file2;?></a></td>
												<td><a href="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/uploads/<?php echo $row->file3 ?>"><?php echo $row->file3;?></a></td>
