				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">User |Give Feedback </h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>User</span>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<?php echo htmlentities($_SESSION['msg1']="");?></p>	--->
													<form role="form" name="book" action="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/FeedbackController/process" method="post"  >
														
<div class="form-group">
														<span class="input-icon">
									<input type="text" class="form-control" name="sender_name" placeholder="sender_name">
