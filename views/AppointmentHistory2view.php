...
<html lang="en">
	<head>
		<title>Receiver | File Details</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Receiver  | File Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Receiver </span>
...
?>
											...
											<tr>
												...
												<td ><?php $id= $row->file_id;  echo $id;?></td>
												...
												<td><a href="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/uploads/<?php echo $file0 ?>"><?php echo $file0;?></a></td>
											</tr>
											<?php 
$cnt=$cnt+1;
break;
...
$cnt=$cnt+1;
			...
			<div class="form-actions">
								<form role="form" name="book" action="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/ForwardFileContr" method="post"  >
									<input type="hidden" class="form-control" name="forward_id" value="<?php  echo $id?>">
								<button  type="submit" style="margin-right:5px" class="btn btn-primary pull-right" name="forward">
									FORWARD <i class="fa fa-arrow-circle-right"></i>
								</button>
							</form>
			</div>
			<div class="form-actions">
							<form role="form" name="book" action="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/HistoryContr/process" method="post"  >
									<input type="hidden" class="form-control" name="file_id" value="<?php  echo $id?>">
							<button type="submit" style="margin-right:5px" class="btn btn-primary pull-right" name="submit">
