				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">User | Upload File</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>User</span>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								...
								<?php echo htmlentities($_SESSION['msg1']="");?></p>	--->
													<h5>File successfully created</h5>
													<h5>Please upload the supporting document</h5>
													<?php echo $error;?>
													
													<form role="form" name="book" action="http://localhost/CodeIgniter-3.1.8/CodeIgniter-3.1.8/index.php/upload/do_upload"  method="post" enctype="multipart/form-data">
